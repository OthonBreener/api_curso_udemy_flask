...
class Hotel(Resource):
    ...
    @jwt_required #anotação que requere que o usuario esteja logado para atualizar a lista de hoteis
    def post(self, hotel_id):
        ...
        try:
            ...
            return {'message': 'erro interno ao tentar salvar'}, 500
